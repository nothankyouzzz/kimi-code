...
| `/title [<text>]` | `/rename` | Without arguments, display the current session title; with an argument, set a new title (max 200 characters); with `generate`, request an AI-generated title (regenerating the current one) | Yes |
